...
describe('ManagerDashboard', () => {
  ...
  const mockSupplyChainService: any = {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    // Mock del servicio - commented out as service is now Solana-based
  ...
  it('renders dashboard with title', async () => {
    ...
    mockSupplyChainService.isWalletConnected.mockReturnValue(false);
  ...
  it('displays loading state initially', async () => {
    mockSupplyChainService.getAllSerialNumbers.mockImplementation(() => {
  ...
  it('displays tracking cards when data is loaded', async () => {
    ...
    mockSupplyChainService.getAllSerialNumbers.mockResolvedValue(['NB-001']);
  ...
  it('displays correct status badges for different states', async () => {
    ...
    mockSupplyChainService.getAllSerialNumbers.mockResolvedValue(['NB-001', 'NB-002', 'NB-003', 'NB-004']);
    
    // Mock para diferentes estados
    mockSupplyChainService.getNetbookReport
